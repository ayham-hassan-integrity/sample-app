        ...
        <x-backend.card>
            ...
            <x-slot name="body">
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="name" class="form-control" placeholder="{{  __('name') }} " value="{{   $test->title }}  "  />
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="description" class="form-control" placeholder="{{  __('description') }} " value="{{   $test->title }}  "  />
                    </div>
